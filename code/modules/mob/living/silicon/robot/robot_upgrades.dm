...
/obj/item/borg/upgrade/admin/
	name = "admin equipment module"
	desc = "Unlocks the admin module, you dirty cheater."
	icon_state = "cyborg_upgrade3"
	require_module = 1

/obj/item/borg/upgrade/admin/action(var/mob/living/silicon/robot/R)
	if(..()) return 0
